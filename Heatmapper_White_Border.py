...
def generate_heatmap_with_images(csv_file_path, heatmap_title, images):
    ...
    cell_width = ax.get_window_extent().width / color_data.shape[1]
    cell_height = ax.get_window_extent().height / color_data.shape[0]
    ...
    for image_info in images:
        ...
        border_size = 5  # Adjust the size of the border as needed
        ...
        ax.imshow(np.array(img_with_border), aspect='auto', extent=[x_pos, x_pos + img_width / cell_width, y_pos, y_pos + img_height / cell_height], zorder=10)

    plt.tight_layout()
    plt.show()

# Example usage
csv_file_path = "Substrate_Scope_Thermal_Borylation.csv"  # Replace with your CSV file path
heatmap_title = ""
images = [
    {"path": "1_DMP_Boryl.png", "row": 0, "col": 0},
    {"path": "2_2_6_Lutidine_Boryl.png", "row": 0, "col": 1},
    {"path": "3_Nicotinate_Boryl.png", "row": 0, "col": 2},
    {"path": "4_AminoPyrimi_Boryl.png", "row": 1, "col": 0},
    {"path": "5_Phtalazine_Boryl.png", "row": 1, "col": 1},
    {"path": "6_Thiazole_Boryl.png", "row": 1, "col": 2},
]
